...
// Custom icon components for SmartEcoApp
export function RecycleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function ScanIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
